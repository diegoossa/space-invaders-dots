...
namespace Unity.Entities.Tests
{
    ...
    class SerializeTests : ECSTestsFixture
    {
        ...
        public class ManagedComponent : IComponentData, IEquatable<ManagedComponent>
        {
            ...
            public bool Equals(ManagedComponent other)
            {
                return String.Equals(other) && Map.Equals(other.Map);
            }

            public override int GetHashCode()
            {
                return (String.GetHashCode() * 397) ^ Map.GetHashCode();
            }
        }

        public class ManagedComponent2 : IComponentData, IEquatable<ManagedComponent2>
        {
            public List<string> List;

            public ManagedComponent2()
            {
            }

            public bool Equals(ManagedComponent2 other)
            {
        ...
        public class ManagedComponentCustomClass : IComponentData, IEquatable<ManagedComponentCustomClass>
        {
            ...
            public bool Equals(ManagedComponentCustomClass other)
            {
                return mClass.Equals(other) && mClass.Equals(other.mClass);
            }

            public override int GetHashCode()
            {
                return (mClass.GetHashCode() * 397) ^ mClass.GetHashCode(); 
            }
        }
