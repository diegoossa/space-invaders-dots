...
namespace Unity.Scenes.Tests
{
    public class SaveAndLoadEndToEnd : ECSTestsFixture
    {
        ...
        class ManagedObjectWithObjectReference : IComponentData, IEquatable<ManagedObjectWithObjectReference>
        {
            public Texture2D Texture;

            public bool Equals(ManagedObjectWithObjectReference other)
            {
