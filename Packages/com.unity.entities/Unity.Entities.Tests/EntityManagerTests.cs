...
namespace Unity.Entities.Tests
{
    ...
    class EntityManagerTests : ECSTestsFixture
    {
        ...
        class TestInterfaceManagedComponent : TestInterface, IComponentData, IEquatable<TestInterfaceManagedComponent>
        {
            public int Value;

            public bool Equals(TestInterfaceManagedComponent other)
            {
        ...
        public class ComplexManagedComponent : IComponentData, IEquatable<ComplexManagedComponent>
        {
            ...
            public bool Equals(ComplexManagedComponent other)
            {
                return false;
            }
