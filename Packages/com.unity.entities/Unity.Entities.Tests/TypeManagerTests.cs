...
namespace Unity.Entities.Tests
{
    class TypeManagerTests : ECSTestsFixture
    {
...
#if !NET_DOTS
        [DisableAutoTypeRegistration]
        class ManagedComponentDataNotEquatable : IComponentData
        {
        }
        ...
        [DisableAutoTypeRegistration]
        class ManagedComponentDataNoGetHashCode : IComponentData, IEquatable<ManagedComponentDataNoGetHashCode>
        {
            public bool Equals(ManagedComponentDataNoGetHashCode other)
            {
                return true;
            }
        }

        [TestCase(typeof(ManagedComponentDataNotEquatable), @"\b(IEquatable)\b", TestName = "Class IComponentData not implementing IEquatable")]
        [TestCase(typeof(ManagedComponentDataNoGetHashCode), @"\b(GetHashCode)\b", TestName = "Class IComponentData not overriding GetHashCode()")]
