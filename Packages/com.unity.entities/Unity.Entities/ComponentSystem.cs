    ...
    public abstract class JobComponentSystem : ComponentSystemBase
    {
        ...
        protected internal ForEachLambdaJobDescription Entities
        {
            get
            {
                ...
                return new ForEachLambdaJobDescription();
#else
                throw new NotSupportedException("JobComponentSystem.Entities requires Unity 2019.3 && ENABLE_DOTS_COMPILER to be set");
#endif
            }
        }
...
#else
                throw new NotSupportedException("EntityQuery.Chunks requires Unity 2019.3 && ENABLE_DOTS_COMPILER to be set");
#endif
            }
        }
#endif
...
#else
                throw new NotSupportedException("JobComponentSystem.Job requires Unity 2019.3 && ENABLE_DOTS_COMPILER to be set");
#endif
            }
        }
        ...
        private unsafe struct JobHandleData
        {
            ...
            JobHandleData(IntPtr jobGroup, int version)
            {
        ...
        unsafe void AfterOnUpdate(JobHandle outputJob, bool throwException)
        {
            ...
            if (((JobHandleData*)&outputJob)->jobGroup != null)//Checking for default job returned
            {
                JobHandle.ScheduleBatchedJobs();
