...
namespace Unity.Entities.Tests.Conversion
{
    class UnityEngineExtensionsTests : ConversionTestFixtureBase
    {
        ...
        public void ComputeEntityHash_WithGameObjects()
        {
            ...
            var h01 = g0.ComputeEntityGuid(0);
            var h02 = g0.ComputeEntityGuid(1);
            
            var h10 = g1.ComputeEntityGuid(0);
            var h11 = g1.ComputeEntityGuid(1);

            var h20 = u0.ComputeEntityGuid(0);
            var h21 = u0.ComputeEntityGuid(1);

            var h30 = u1.ComputeEntityGuid(0);
            var h31 = u1.ComputeEntityGuid(1);
        ...
        public void ComputeEntityHash_WithComponent_UsesGameObject()
        {
            ...
            Assert.That(go.ComputeEntityGuid(0), Is.EqualTo(component.ComputeEntityGuid(0)));
        }
    }
}
