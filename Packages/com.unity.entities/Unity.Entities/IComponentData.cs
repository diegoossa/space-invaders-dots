...
{
    /// <summary>
    /// An interface for constraining types that can be queried off of an entity.
    /// </summary>
    /// <remarks>
    /// An interface that is used to restrict the types that can be queried off of an entity.  Any type
    /// that will work with an Entity.With query should implement this type.  This includes the following:
    /// * <see cref="IComponentData"/> -- a component holding specific data on an entity
    ...
    /// </remarks>
    public interface IComponentData : IBaseEntityData
    {
    }
    ...
    /// </remarks>
    public interface ISharedComponentData : IBaseEntityData
    {
    }
