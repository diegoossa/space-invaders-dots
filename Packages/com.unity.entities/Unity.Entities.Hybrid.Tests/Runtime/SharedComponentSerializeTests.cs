...
namespace Unity.Entities.Tests
{
    class SharedComponentSerializeTests : ECSTestsFixture
    {
        ...
        public class ManagedComponentWithObjectReference : IComponentData, IEquatable<ManagedComponentWithObjectReference>
        {
            public UnityEngine.Texture2D Texture;

            public ManagedComponentWithObjectReference()
            {
            }

            public bool Equals(ManagedComponentWithObjectReference other)
            {
