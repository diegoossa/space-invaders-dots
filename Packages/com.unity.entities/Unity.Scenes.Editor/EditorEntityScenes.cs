...
namespace Unity.Scenes.Editor
{
    public static class EditorEntityScenes
    {
        ...
        public static void WriteEntityScene(SubScene scene)
        {
            ...
            WriteEntityScene(scene.EditingScene, guid);
        }
#endif
...
#else
            var path = EntityScenesPaths.GetSceneCachePath(sceneGUID, type, subsectionName);
...
//                entityManager.Debug.CheckInternalConsistency();
            ...
            ManualEntityBinaryCache.NotifyEntityCacheChanged(sceneGUID);
