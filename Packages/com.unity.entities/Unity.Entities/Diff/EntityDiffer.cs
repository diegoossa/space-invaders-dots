...
namespace Unity.Entities
{
    ...
    /// </summary>
    [Serializable]
    internal class DuplicateEntityGuidException : Exception
    {
        /// <summary>
        /// The duplicate guids found in during the diff.
        /// </summary>
        ...
        /// <summary>
        /// Initialized a new instance of the <see cref="DuplicateEntityGuidException"/> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DuplicateEntityGuidException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
            ...
            Allocator allocator)
        {
            ...
            using (var dstChunks = dstEntityQuery.CreateArchetypeChunkArray(Allocator.TempJob, out var dstChunksJob))
            {
                    ...
                    dependsOn: archetypeChunkChangesJobDependencies))
                {
                    ...
                    {
                        var duplicateEntityGuids = default(NativeList<EntityGuid>);
                        ...
                        try
                        {
                            ...
                            if (duplicateEntityGuids.IsCreated && duplicateEntityGuids.Length > 0)
                            {
                                throw new DuplicateEntityGuidException(message:
                                                                       $"Found {duplicateEntityGuids.Length} {nameof(EntityGuid)} components that are shared by more than one Entity, " +
                                                                       $"see the {nameof(DuplicateEntityGuidException.DuplicateEntityGuids)} property for more information.")
                                {
                                    DuplicateEntityGuids = duplicateEntityGuids.ToArray()
                                };
                            }
