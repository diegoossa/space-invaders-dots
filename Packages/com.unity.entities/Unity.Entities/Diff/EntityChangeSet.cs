...
namespace Unity.Entities
{
    ...
    public struct EntityGuid : IComponentData, IEquatable<EntityGuid>, IComparable<EntityGuid>
    {
        ...
        public EntityGuid(ulong aa, ulong bb)
        {
            a = aa;
            b = bb;
        }
        ...
        public override bool Equals(object obj) =>  throw new InvalidOperationException("Calling this function is a sign of inadvertent boxing");
