...
namespace Unity.Entities
{
    internal unsafe struct ManagedDeferredCommands : IDisposable
    {
        ...
        public void ReplicateManagedObjects(Chunk* srcChunk, int srcStartIndex,
            Chunk* dstChunk, int dstBaseStartIndex, int count)
        {
    ...
    internal unsafe partial struct EntityComponentStore
    {
        ...
        static int GetComponentArraySize(int componentSize, int entityCount) => CollectionHelper.Align(componentSize * entityCount, CollectionHelper.CacheLineSize);
